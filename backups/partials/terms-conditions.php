...
<h2 style="text-align: center; text-transform: uppercase; font-size: 16px;">Privacy Policy</h2>

<p>We are very happy that you have expressed your interest in our company. Data protection is a particularly high priority for the management of iMLOVE. If the processing of personal data is necessary and there is no legal basis for such processing, we usually obtain the consent of the data subject. By means of this data protection declaration, our company wishes to inform the general public about the nature, scope and purpose of the personal data that we collect, use and process. In addition, data subjects are informed, by means of this data protection declaration, of the rights to which they are entitled.
As data controller, iMLOVE has implemented numerous technical and organizational measures to ensure the most complete protection of personal data processed through this app. However, data transmissions over the Internet can in principle have security vulnerabilities, so absolute protection may not be guaranteed. For this reason, each data subject is free to transfer personal data to us via alternative means, e.g. by telephone.</p>
...
<p>Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to iMLOVE, Cupertino, CA 95011.</p>
...
<p>Website refers to iMLOVE, accessible from iMLOVE.com</p>
...
<p>By email: <a href="mailto:privacy@imlove.app">privacy@imlove.app</a> </p>